...
int registered_channels[10] = {6, 6, 6, 6, 6, 6, 6, 6, 6};
int registered_low_addresses[10] = {21, 21, 21, 21, 21, 21, 21, 21, 21};
int registered_high_addresses[10] = {15, 9, 16, 3, 17, 14, 5, 18, 11};
